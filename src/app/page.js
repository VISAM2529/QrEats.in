    ...
    >
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          {["features", "analytics", "pricing"].map((id) => (
            <button
              key={id}
      ...
      {isMenuOpen && (
        <div className="md:hidden mt-4 pb-4">
          <nav className="flex flex-col space-y-4">
            ...
            <button
              onClick={() => handleScrollTo("pricing")}
              className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-2 rounded-full font-semibold w-fit"
            >
              Get Started
            </button>
          </nav>
  ...
  <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 via-white to-red-50 pt-20">
    <div className="container mx-auto px-6 text-center max-w-4xl">
      ...
      <p className="text-xl text-gray-600 mb-8 leading-relaxed">
        Streamline orders with QR code technology and gain powerful insights
        with advanced analytics. Manage your cafe like never before with QrEats.
      </p>
  ...
  const features = [
    {
      ...
      description:
        "Customers can scan QR codes at tables to browse menu and place orders instantly without waiting for staff.",
    ...
    },
    {
      ...
      description:
        "Comprehensive dashboard to manage orders, menu items, staff, and monitor real-time cafe operations.",
    ...
    },
    {
      ...
      description:
        "Get detailed insights on sales, popular items, peak hours, and customer behavior patterns.",
    ...
    },
    {
      ...
      description:
        "Live order tracking, kitchen notifications, and instant updates across all devices.",
    ...
    },
    {
      ...
      description:
        "Manage staff roles, permissions, and track performance with detailed reporting.",
    ...
    },
    {
      ...
      description:
        "Enterprise-grade security with encrypted data and reliable cloud infrastructure.",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Everything you need to run your cafe efficiently, from QR ordering
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`w-16 h-16 bg-gradient-to-r ${feature.gradient} rounded-2xl flex items-center justify-center text-white mb-6 group-hover:rotate-3 transition-transform duration-300`}
              >
                {feature.icon}
              </div>
  ...
  const analyticsFeatures = [
    {
      ...
      description:
        "Track which dishes customers love most and optimize your menu accordingly",
    },
    {
      icon: <Calendar className="w-6 h-6" />,
      title: "Time-based Reports",
      description:
        "Daily, weekly, and yearly analytics to understand trends and patterns",
    },
    {
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Make data-driven decisions with comprehensive analytics that show
              you exactly what's working and what's not in your cafe.
            </p>
  ...
  const plans = [
    {
      ...
      period: "per year",
      description:
        "Perfect for cafes that want powerful admin dashboard features",
      features: [
    ...
    },
    {
      ...
      period: "per year",
      description:
        "Full-featured solution with QR ordering and advanced analytics",
      features: [
    ...
    <section id="pricing" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Choose the perfect plan for your cafe. No hidden fees, no
          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`relative bg-white rounded-3xl shadow-xl p-8 ${
                plan.popular
                  ? "ring-4 ring-orange-500 ring-opacity-20 scale-105"
                  : ""
              }`}
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <div className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-2 rounded-full text-sm font-semibold flex items-center">
                    <Award className="w-4 h-4 mr-2" /> Most Popular
                  </div>
                </div>
              )}
  ...
  <footer className="bg-gray-900 text-white py-16">
    <div className="container mx-auto px-6">
      <div className="grid md:grid-cols-4 gap-8 mb-12">
        <div className="col-span-1">
          ...
          <p className="text-gray-400">
            Simplifying cafe management with QR ordering and analytics.
          </p>
        </div>
      ...
      <div className="text-center text-gray-500">
        © {new Date().getFullYear()} QrEats. All rights reserved.
      </div>
    </div>
  </footer>
);
